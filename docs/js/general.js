...
(function () {
  ...
  application.register("hello", (_temp = _class = /*#__PURE__*/function (_Stimulus$Controller) {
    _inherits(_class, _Stimulus$Controller);
    ...
    return _class;
  }(Stimulus.Controller), _defineProperty(_class, "targets", ["name", "output"]), _temp));
})();
